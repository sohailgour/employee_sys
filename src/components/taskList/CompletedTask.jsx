...
const CompletedTask = ({data}) => {
  return (
    ...
    <div className="p-5 h-[40vh] w-[300px]">
      ...
      <button className="w-full bg-emerald-500/30 text-white py-2 px-4 rounded-lg text-sm font-medium flex items-center justify-center gap-2">
